<header>
    <nav>
        <ul class="navbar">
            <li><a href="./../../index.php" class="navitem"><img class="backToHome" src="/assets/img/logo.png" alt=""></a></li>
            <li><a target="_blank" rel="noreferrer" href="https://bit.ly/3DwLLti" class="navitem">Informations</a></li>
